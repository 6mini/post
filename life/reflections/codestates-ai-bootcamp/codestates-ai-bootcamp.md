...
코드스테이츠 AI 부트캠프를 통해 나아갈 수 있는 직무는 크게 나눠 데이터 분석가, 데이터 엔지니어, ML 및 DL 엔지니어, 데이터 사이언티스트 등이 있다. 여러 가지를 경험해 보며 흥미나 적성을 느끼는 분야에 선택과 집중을 할 수 있는 시스템이 좋았다. 아 물론 필자같이 빠르게 정하다 보면, 관련이 없는 커리큘럼에서는 흥미를 잃고 학습을 소홀하게 될 가능성도 있다.
