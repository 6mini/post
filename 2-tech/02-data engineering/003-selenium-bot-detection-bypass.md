...
3단계로 VPN을 이용해본다. 해외에서 접속한 경우를 막을 가능성을 위해 VPN을 사용한다. 필자는 NordVPN(https://nordvpn.com/ko/offer-site/)라는 유료 서비스를 사용하였지만, 이 마저도 성공할 수 없었다. 무료로 사용할 수 있는 VPN 서비스도 있으니 찾아보고 적용해보길 바란다. 최종 단계로 넘어가보자.
